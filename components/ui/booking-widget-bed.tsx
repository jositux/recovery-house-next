...
export function BookingWidgetBed({
  ...
  }, [price, nights, cleaning, calculateDiscount]);
  ...
  return (
    <div className="border rounded-lg p-6 space-y-6 shadow-md bg-white">
      <div className="flex justify-between items-center">
        <div>
          <span className="text-3xl font-bold text-[#39759E]">
            ${price.toLocaleString("es-CO")} USD
          </span>
          ...
          <PopoverContent className="w-auto p-0" align="start">
            <Calendar
              ...
              disabled={(date) => {
                ...
                const hasBetweenReservation = checkIn
                  ? hasReservedDateBetween(checkIn, date)
                  : false;
                return (
                  isBeforeOrEqualCheckIn ||
                  isDateReserved(date) ||
                  hasBetweenReservation
                );
              }}
          ...
          <div className="flex items-center space-x-2">
            <p className="text-sm text-blue-800 font-medium">
              {nights >= minLongStayRange && nights <= maxLongStayRange ? (
                <>
                  Elegiste <span className="font-bold">{nights} noches</span>{" "}
                  que equivale a una
                ...
                <>
                  {nights < minMediumStayRange && (
                    <span className="text-blue-700">
                      ¡Considera quedarte {minMediumStayRange} noches o más para
          ...
          <div className="space-y-2 bg-gray-50 p-4 rounded-md">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-semibold">
                ${(price * nights).toLocaleString("es-CO")}{" "}
            ...
            {calculateDiscount > 0 && (
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-semibold text-green-600">
                  -$
                  {((price * nights * calculateDiscount) / 100).toLocaleString(
                    "es-CO"
                  )}{" "}
                  USD
                </span>
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-semibold">
                ${cleaning.toLocaleString("es-CO")} USD
              </span>
            </div>
