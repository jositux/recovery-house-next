...
export function SearchBar({ 
    lang = "es", 
    availableLocations = [] // ✅ Nueva prop con valor por defecto
}: { 
    lang?: string; 
        ...
        <div className="flex items-center px-6 gap-1 p-2 bg-white rounded-2xl shadow-lg border">
          ...
          <div className="relative flex-1">
            <div className="py-1">
              ...
              {/* 🛑 PASAR EL PROP availableLocations a LocationAutocomplete */}
              <LocationAutocomplete
                ...
                lang={lang}
                availableLocations={availableLocations} // ✅ Propiedad pasada
              />
            </div>
          </div>
