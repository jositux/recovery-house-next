...
const assistanceLinks = [
  { href: "/about", labelEs: "Acerca de", labelEn: "About Us", icon: Info },
  { href: "/terms", labelEs: "Términos y condiciones", labelEn: "Terms & Conditions", icon: FileText },
  { href: "/policy", labelEs: "Políticas de uso", labelEn: "Usage Policies", icon: FileText },
  { href: "/privacidad", labelEs: "Política de privacidad", labelEn: "Privacy Policy", icon: ShieldCheck },
]
...
export default function MobileMenuOverlay({ isOpen, onClose, lang, isSpanish, currentLang }: MobileMenuOverlayProps) {
  return (
    <AnimatePresence>
      {isOpen && (
          ...
          >
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b pb-4">
                <Image src="/assets/logo2.svg" alt="Recovery Care Solutions" width={130} height={38} />
            ...
            <div className="border-t pt-6 mt-8">
              <p className="text-xs text-gray-500 mb-1">{isSpanish ? "Contáctenos:" : "Contact us:"}</p>
              <a
