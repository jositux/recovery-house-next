  ...
  try {
    const response = await axios.get<{ data: any[] }>("/webapi/items/Provider", {
      ...
      params: {
        ...
        fields: "*,serviceTags.serviceTags_id,extraTags.ExtraTags_id,RNTFile.filename_download,RNTFile.id,taxIdEINFile.filename_download,taxIdEINFile.id, taxIdApproved",
      },
    });
    ...
    const transformedData: Provider[] = response.data.data.map((item) => ({
      ...
      taxIdApproved: item.taxIdApproved || false,
