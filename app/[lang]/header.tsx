            ...
            >
              <div className="space-y-6">
                  ...
                  <ul className="space-y-3">
                    {assistanceLinks.map((link) => (
                      <li key={link.href}>
                        <Link
                          href={`/${lang}${link.href}`}
                          className="text-gray-700 hover:text-[#39759E] font-medium block transition-colors"
                        >
                ...
                <div className="border-t pt-4">
                  ...
                  <Link
                    href="#"
                    className="flex items-center gap-2 text-gray-700 hover:text-[#39759E] font-medium transition-colors"
                  >
              ...
              <div className="border-t pt-6 mt-8">
                ...
                <a
                  ...
                  className="text-xs font-semibold text-[#39759E] hover:underline flex items-center gap-1"
                >
