...
const translations: Record<string, TranslationText> = {
  es: {
    ...
    noServiceText: "Registra tu servicio para pacientes y empezá a conectar con quienes necesitan tu ayuda",
  ...
  en: {
    ...
    noServiceText: "Register your patient care service and start connecting with those who need your help",
