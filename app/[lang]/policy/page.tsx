...
export default function TermsAndConditionsPage() {
  ...
  // Validación segura de locale igual que en AboutUs
  ...
  const formattedDate = format(new Date(), "d LLLL yyyy", {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-12">
          ...
          <section className="border-b border-border pb-8">
            <h2
              className={`${fraunces.className} text-xl md:text-2xl font-normal mb-6 text-foreground`}
            >
              {isSpanish
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-foreground">
                  {isSpanish
                    ...
                    : "5.2. Objections to Booking Policies"}
                </h3>
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li className="leading-relaxed">
                    {isSpanish
                      ? "Pandemias o Epidemias explícitamente declaradas por los organismos gubernamentales de salud pública de la locación de destino."
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 text-foreground">
                  {isSpanish
                    ...
                    : "5.3. Conditions according to the type of stay"}
                </h3>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-foreground">
                  {isSpanish
                    ...
                    : "5.4. General Cancellation Conditions"}
                </h3>
                <ul className="space-y-2 list-disc list-inside">
                  <li className="leading-relaxed">
                    {isSpanish
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose">
                ...
                <div className="bg-card border border-border p-6 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-2 list-disc list-inside text-xs md:text-sm text-muted-foreground">
                    <li>
                      {isSpanish
                        ? "Incluye anulación gratuita las primeras 24 horas."
                        : "Includes free cancellation within the first 24 hours."}
                    </li>
                    <li>
                      {isSpanish
                        ? "Para estadías largas (+10 noches), es reembolsable bajo condiciones."
                        : "For long stays (+10 nights), it is refundable under conditions."}
                    </li>
                    <li>
                      {isSpanish
                        ? "Debe completarse 72h antes del check-in o se retiene como penalización."
                        : "Must be completed 72h before check-in or it is retained as penalty."}
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="border-b border-border pb-8">
            ...
            >
              {isSpanish
                ...
                : "7. Booking Modification Policies"}
            </h2>
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-semibold mb-2 text-foreground">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 text-foreground">
                  {isSpanish
                    ...
                    : "7.2. Conditions according to the type of stay"}
                </h3>
                  ...
                  <div className="bg-card border border-border p-6 rounded-xl shadow-sm">
                    <h4 className="text-base font-semibold mb-2 text-foreground">
                      {isSpanish
                        ...
                        : "a. Short and Medium Stays (1 to 9 nights)"}
                    </h4>
                    <p className="font-medium text-destructive text-sm md:text-base mb-1">
                      {isSpanish
                        ? "Modificaciones: No permitidas bajo ninguna circunstancia."
                        : "Modifications: Not permitted under any circumstances."}
                    </p>
                  ...
                  <div className="bg-card border border-border p-6 rounded-xl shadow-sm">
                    <h4 className="text-base font-semibold mb-3 text-foreground">
                      {isSpanish
                        ...
                        : "b. Long Stays (10 or more nights)"}
                    </h4>
                    <div className="space-y-3 text-sm md:text-base">
                      <div>
                        <p className="font-medium mb-1 text-foreground">
                        ...
                        <p className="text-muted-foreground pl-4">
                          {isSpanish
                            ? "→ Se permite una (1) modificación gratuita por reserva, que puede incluir cambio de fechas y otros detalles."
                            : "→ One (1) free modification per booking is allowed, which may include changing dates and other details."}
                        </p>
                      </div>
                      <div>
                        <p className="font-medium mb-1 text-foreground">
                          {isSpanish
                            ? "Plazos para modificar:"
                            : "Deadlines for modification:"}
                        </p>
                        <p className="text-muted-foreground pl-4">
                          {isSpanish
                            ? "→ Hasta 6 meses antes del check-in, o hasta 72 horas antes para reservas realizadas con poco margen de anticipación."
                            : "→ Up to 6 months before check-in, or up to 72 hours before for bookings made with short notice."}
                        </p>
                      </div>
                      <div>
                        <p className="font-medium mb-1 text-foreground">
                        ...
                        <p className="text-muted-foreground pl-4">
                          {isSpanish
                            ? "→ Si el cambio altera la tarifa, la diferencia será sumada o restada al saldo pendiente (o reembolsada según la política vigente)."
                            : "→ If the change alters the rate, the difference will be added or subtracted from the pending balance (or refunded per current policy)."}
                        </p>
                      </div>
                    </div>
                  </div>
