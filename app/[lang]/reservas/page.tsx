...
import { MapPin, Star, Loader2, BedDouble, Home, ArrowRight, CheckCircle, AlertCircle } from "lucide-react"
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const bookingsResponse = await fetch(`/webapi/items/Booking`)
        ...
        const extractedData = data.map(property => ({
          propertyName: property.name,
          room: property.Rooms,
        }));
      
        console.log("lalalal", extractedData)
