      ...
      <Card className="w-full max-w-3xl overflow-hidden shadow-xl">
        <div className="relative h-64 sm:h-80">
          ...
          <div className="absolute bottom-0 left-0 p-6 text-white">
            ...
            <p className="text-lg sm:text-xl text-gray-200">Has elegido la opción de huésped</p>
          </div>
        </div>

        <CardContent className="p-6">
          <p className="text-lg text-gray-700 mb-6">
            Como huésped, tienes acceso a una amplia variedad de alojamientos únicos y experiencias inolvidables. ¿Estás
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card className="bg-indigo-50 border-indigo-200">
              ...
              <CardContent>
                <h3 className="text-lg font-semibold mb-2">Buscar alojamiento</h3>
                <p className="text-sm text-gray-600">Encuentra el lugar perfecto para tu próxima estancia.</p>
              </CardContent>
            </Card>
            <Card className="bg-gray-50 border-gray-200">
              ...
              <CardContent>
                <h3 className="text-lg font-semibold mb-2">Explora destinos</h3>
                <p className="text-sm text-gray-600">Descubre nuevos lugares y planifica tu viaje ideal.</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
