...
import { Building2, Home, Save, ArrowRight, ArrowLeft } from "lucide-react"
      ...
      await Promise.all(
        rooms.map(async (room) => {
          const roomData: RoomData = {
            ...
            mainImage: room.mainImage || form.getValues("mainImage"),
            photos: room.photos.length > 0 ? room.photos : [room.mainImage || form.getValues("mainImage")],
