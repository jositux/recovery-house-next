        ...
        <div className="mb-12">
          <div className="rounded-xl mb-8">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
              ...
              {isOwner && (
                <Link
                  href={`/mi-panel/propiedades/${property.id}/room/create`}
            ...
            {property.Rooms && property.Rooms.length > 0 ? (
              ...
              <div className="bg-white border rounded-lg shadow-lg p-8 text-center">
                ...
                <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
                  ¡Convertí tu espacio en ingresos! Ya sea una habitación
                  privada o una cama en un cuarto compartido, mostrala al mundo
                  y empezá a recibir reservas hoy mismo.
                </p>
                {isOwner && (
