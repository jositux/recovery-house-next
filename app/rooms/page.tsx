...
function RoomsPageContent() {
  ...
  const filteredRooms = useMemo(() => {
    ...
    return allRooms.filter((room) => {
      ...
      const matchesLocation = room.propertyLocation
        .toLowerCase()
  ...
  return (
    <div className="mx-auto w-full">
      ...
      <div
        className={`flex mt-8 mb-16 transition-all duration-300 ease-in-out ${
          isMapVisible ? "gap-6" : "gap-0"
        }`}
      >
        <div
          className={`transition-all duration-300 ease-in-out ${
            isMapVisible ? "w-2/3" : "w-full pr-8"
          }`}
        >
